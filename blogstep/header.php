...
<?php _e( 'Skip to content', 'blogstep' ); ?></a>
...
<?php } ?>
  <!--header-->
    <?php do_action('blogstep_action_header_section'); ?> 
  <!--header end-->
  <!-- Add News ticker -->
  <?php do_action('blogstep_action_front_page_ticker_section'); ?> 
  <!--mainfeatured start-->
<div class="mainfeatured">
  <!--container-->
  <div class="container">    
      <?php do_action('blogstep_action_featured_section'); ?> 
  </div><!--/container-->
</div>
<!--mainfeatured end-->
<?php
