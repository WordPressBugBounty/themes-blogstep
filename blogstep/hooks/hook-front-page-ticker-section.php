<?php 
if (!function_exists('blogstep_front_page_ticker_section')) :
    /**
     *
     * @since Blogus
     *
     */
    function blogstep_front_page_ticker_section(){
...
add_action('blogstep_action_front_page_ticker_section', 'blogstep_front_page_ticker_section', 40);