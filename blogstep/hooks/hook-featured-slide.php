<?php
if (!function_exists('blogstep_featured_section')) :
    /**
     *
     * @since Blogstep
     *
     */
    function blogstep_featured_section(){ 
...
add_action('blogstep_action_featured_section', 'blogstep_featured_section', 40);